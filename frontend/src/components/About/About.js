    ...
    <div className="about-container" >
      ...
      <div className="team-container-wrapper">
        <div className="feature"> 
          ...
          <ul className="team-social">
            <li>
              <a className="icons" href="http://www.facebook.com" target="_blank">
              <FontAwesomeIcon icon={faFacebookSquare} size={28}/>
              </a>
            </li>
            <li>
              <a className="icons" href="http://www.twitter.com" target="_blank">
              <FontAwesomeIcon icon={faTwitterSquare} />
              </a>
            </li>
            <li>
              <a className="icons" href="https://www.linkedin.com/in/oliver-abreu-6105a2186/" target="_blank">
      ...
      <div className="feature"> 
        ...
        <ul className="team-social">
            ...
            <li>
              <a className="icons" href="https://www.linkedin.com/in/jonathan-dorety-252948185/" target="_blank">
              <FontAwesomeIcon icon={faLinkedin} />
              </a>
            </li>
          </ul>
      ...
      <img src={Melvin} className="team-img" alt="Team member" />
        ...
        <ul className="team-social">
            ...
            <li>
              <a className="icons" href="https://www.linkedin.com/in/melvin-merlos-49079a73/" target="_blank">
              <FontAwesomeIcon icon={faLinkedin} />
              </a>
            </li>
          </ul>
      ...
      <img src={Erin} className="team-img" alt="Team member" />
        ...
        <ul className="team-social">
            ...
            <li>
              <a className="icons" href="https://www.linkedin.com/in/erin-scriber/" target="_blank">
              <FontAwesomeIcon icon={faLinkedin} />
              </a>
            </li>
          </ul>
      ...
      <img src={Jesse} className="team-img" alt="Team member" />
        ...
        <ul className="team-social">
            ...
            <li>
              <a className="icons" href="https://www.linkedin.com/in/jesse-theisen/" target="_blank">
              <FontAwesomeIcon icon={faLinkedin} />
              </a>
            </li>
          </ul>
