		...
		<div className="about-container">
			...
			<div className="team-container-wrapper">
				...
				<div className="feature">
					...
					<p>
						Deserunt sunt consectetur adipisicing do minim aute
						labore nulla aute ipsum dolor tempor. Ut culpa deserunt
						dolore dolor occaecat ut exercitation. Nostrud do duis
						fugiat voluptate. Dolor laboris exercitation occaecat ex
						eiusmod duis adipisicing adipisicing mollit sit
						consectetur officia. Culpa quis sint enim tempor ut eu
						eu duis. Ex ad commodo adipisicing tempor adipisicing ex
						ad.
					</p>
					<ul className="team-social">
						<li>
				...
				<div className="feature">
					...
					<ul className="team-social">
						...
						<li>
							<a href="https://www.linkedin.com/in/melvin-merlos-49079a73/">
								<FontAwesomeIcon icon={faLinkedin} />
							</a>
						</li>
					</ul>
